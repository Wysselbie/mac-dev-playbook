...
git clone https://github.com/Wysselbie/mac-dev-playbook.git "/Users/${WHOAMI}/.setup" > /dev/null;
git clone https://github.com/Wysselbie/dotfiles.git "/Users/${WHOAMI}/Documents/dotfiles" > /dev/null;
